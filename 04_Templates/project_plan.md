...
Describe the overall strategy for executing the project.

Focus on the logic and sequence of the work rather than detailed activities.
...
Define the main checkpoints used to determine whether the project is
...
Evaluate progress primarily through:
...
When a relevant deviation occurs:
